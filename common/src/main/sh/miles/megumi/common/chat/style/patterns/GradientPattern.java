package sh.miles.megumi.chat.style.patterns;
...
public class GradientPattern implements ChatStylePattern {
    ...
    public String process(String message) {
        ...
        while (matcher.find()) {
            ...
            final net.md_5.bungee.api.ChatColor[] gradient = ChatUtil.gradient(color1, color2, text.length());

            message = message.replace(matcher.group(), ChatUtil.applyColorArray(text, gradient));
        }
